...
def graphrec(name):
    ...
    X1=np.array(Xf1).reshape(len(AuthorList),1,50)
    X2=np.array(Xf2).reshape(len(AuthorList),1,50)
...
print("recall",recall)
print("f1",f1)
pickle.dump(prec,open("pickles/prec_dl_1.pkl","wb"))
pickle.dump(f1,open("pickles/f1_dl_1.pkl","wb"))
pickle.dump(recall,open("pickles/recall_dl_1.pkl","wb"))
