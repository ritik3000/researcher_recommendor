...
lstm_out=LSTM(output_dim=1,activation='sigmoid',return_sequences=False)
...
lstm_out_11=lstm_out(lstm_out_1)
lstm_out_21=lstm_out(lstm_out_2)
lstm_out_12=lstm_out(lstm_out_11)
lstm_out_22=lstm_out(lstm_out_21)
lstm_out_13=lstm_out(lstm_out_12)
lstm_out_23=lstm_out(lstm_out_22)
lstm_out_14=lstm_out(lstm_out_13)
lstm_out_24=lstm_out(lstm_out_23)
# max_pooling_1=max_pooling(lstm_out_1)
# max_pooling_2=max_pooling(lstm_out_2)


concatenate_layer=Concatenate()([lstm_out_14,lstm_out_24])
